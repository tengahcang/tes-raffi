...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: #141E46" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('landing') }}">
                ...
                <div class="sidebar-brand-text mx-4">Dashboard</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('order.history')}}">
                    ...
                    <span>{{ __('Riwayat Pesanan Saya') }}</span>
                </a>
            </li>

            <!-- Nav Item - Review -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('order.review')}}">
                    <i class="fa-solid fa-star"></i>
                    <span>{{ __('Review Saya') }}</span>
                </a>
            </li>
